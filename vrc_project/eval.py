...
class TestModel(chainer.training.Extension):
    ...
    テストを行うExtention
    """
    def __init__(self, _trainer, _direc, _source, _voice_profile, _sp_input_length, _label_sample, name):
        """
        変数の初期化と事前処理
        Parameters
        ----------
        ...
        self.model_sp = _trainer.updater.gen_sp
    ...
    def convert(self):
        ...
        _tmp = self.model_sp(self.source_pp)
        result = result * _tmp
